                ...
                <div class="col-lg-3 col-md-12 sidebars-right theiaStickySidebar section-bulk-widget">
                    <aside class="card file-manager-sidebar mb-0">
                        ...
                        <div class="space-manager p-4">
                            <img src="{{ URL::asset('/assets/img/icons/half-circle.svg') }}" alt="Folder">
                                ...
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/assets/img/icons/folder.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/assets/img/icons/pdf-02.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/assets/img/icons/image.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        class="d-flex align-items-center justify-content-center bg-light-red bg p-4">
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/assets/img/icons/video.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="detail">
                                    <a href="javascript:void(0);"
                                        class="d-flex align-items-center justify-content-center bg-light-orange bg p-4">
                                        <span class="d-flex align-items-center justify-content-center"><img
                                                src="{{ URL::asset('/assets/img/icons/audio.svg') }}"
                                                alt="Folder"></span>
                                    </a>
                                    <div class="d-flex align-items-center justify-content-between info">
                                    ...
                                    <div class="owl-carousel folders-carousel owl-theme">
                                        <div class="folders p-3">
                                            <div class="d-flex align-items-center justify-content-between head">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('/assets/img/icons/folder.svg') }}"
                                                ...
                                                <div class="group-avatar">
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            data-bs-placement="right" aria-label="Member 1"
                                                            data-bs-original-title="Member 1"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-6.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            data-bs-placement="right" aria-label="Member 2"
                                                            data-bs-original-title="Member 2"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-14.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            ...
                                                            data-bs-original-title="Member 3"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-15.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            ...
                                                            data-bs-original-title="Member 4"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-16.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            ...
                                                            data-bs-original-title="Member 5"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-17.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="count">
                                                ...
                                                <div class="group-avatar">
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                                            data-bs-placement="right" aria-label="Member 1"
                                                            data-bs-original-title="Member 1"><img
                                                                src="{{ URL::asset('/assets/img/avatar/avatar-18.jpg') }}"
                                                                alt="Avatar"></a>
                                                    </span>
                                                    <span class="avatar">
                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip"
                                ...
                                <div class="accordion-body">
                                    <div class="owl-carousel files-carousel owl-theme">
                                        <div class="folders p-3">
                                            <div class="d-flex align-items-center justify-content-between head">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('/assets/img/icons/pdf-02.svg') }}"
                                                        alt="File" class="me-2">
                                        ...
                                        <div class="folders p-3">
                                            <div class="d-flex align-items-center justify-content-between head">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ URL::asset('/assets/img/icons/xls.svg') }}"
                                                        alt="File" class="me-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="{{ url('product-list') }}"
                                                class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/assets/img/icons/xls.svg') }}" alt="Product"
                                                    class="me-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="{{ url('product-list') }}"
                                                class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/assets/img/icons/video.svg') }}"
                                                    alt="Product" class="me-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="{{ url('product-list') }}"
                                                class="product-img d-flex align-items-center">
                                                <img src="{{ URL::asset('/assets/img/icons/audio.svg') }}"
                                                    alt="Product" class="me-2">
                                                <span>voice.mp3</span>
                                            </a>
                                        </td>
