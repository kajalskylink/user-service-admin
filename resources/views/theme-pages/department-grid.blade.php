                ...
                <div class="row">
                        ...
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-01.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-02.jpg') }}" alt="">
                                </div>
                                <h4>Susan Lopez</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-03.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-06.jpg') }}" alt="">
                                </div>
                                <h4>Janet Hembre</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-04.jpg') }}" alt="">
                                </div>
                                <h4>Russell Belle</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-05.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-07.jpg') }}" alt="">
                                </div>
                                <h4>Susan Moore</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-08.jpg') }}" alt="">
                                </div>
                                <h4>Lance Jackson</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-11.jpg') }}" alt="">
                                </div>
                                <h4>Mitchum Daniel</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-12.jpg') }}" alt="">
                                </div>
                                <h4>Susan Moore</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-09.jpg') }}" alt="">
                                </div>
                                <h4>Lance Jackson</h4>
                            </div>
                            <ul class="team-members">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info department-profile-info">
                                <div class="profile-pic">
                                    <img src="{{ URL::asset('/assets/img/users/user-13.jpg') }}" alt="">
                                </div>
                                <h4>Robert Grossman</h4>
                            </div>
                            <ul class="team-members">
