                                        ...
                                        <div class="theme-type-images d-flex align-items-center mb-4">
                                            <div class="theme-image">
                                                <div class="theme-image-set">
                                                    <img src="{{ URL::asset('/assets/img/theme/theme-img-08.jpg') }}"
                                                        alt="">
                                                </div>
                                                <span>Light</span>
                                            </div>
                                            <div class="theme-image">
                                                <div class="theme-image-set">
                                                    <img src="{{ URL::asset('/assets/img/theme/theme-img-09.jpg') }}"
                                                        alt="">
                                                </div>
                                                <span>Dark</span>
                                            </div>
                                            <div class="theme-image">
                                                <div class="theme-image-set">
                                                    <img src="{{ URL::asset('/assets/img/theme/theme-img-10.jpg') }}"
                                                        alt="">
                                                </div>
                                                <span>Automatic</span>
                                            </div>
