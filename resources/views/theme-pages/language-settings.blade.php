                                                ...
                                                <table class="table  datanew">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="language-name d-flex align-items-center">
                                                                    <img src="{{ URL::asset('/assets/img/icons/flag-01.svg') }}"
                                                                        class="me-2" alt="">
                                                                    English
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="language-name d-flex align-items-center">
                                                                    <img src="{{ URL::asset('/assets/img/icons/flag-02.svg') }}"
                                                                        class="me-2" alt="">
                                                                    Arabic
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="language-name d-flex align-items-center">
                                                                    <img src="{{ URL::asset('/assets/img/icons/flag-03.svg') }}"
                                                                        class="me-2" alt="">
                                                                    Chinese
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="language-name d-flex align-items-center">
                                                                    <img src="{{ URL::asset('/assets/img/icons/flag-04.svg') }}"
                                                                        class="me-2" alt="">
                                                                    Hindi
                                                                </div>
                                                            </td>
