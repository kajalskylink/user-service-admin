                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-05.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-06.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-07.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-08.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-09.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-10.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-11.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-12.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-13.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-14.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn">
                                        ...
                                        <ul class="w-100">
                                            <li class="flex-column align-items-start">
                                                <div class="d-flex align-items-center justify-content-between w-100 mb-2">
                                                    <div class="security-type d-flex align-items-center">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/icons/payment-icon-15.svg') }}"
                                                                alt="Payment">
                                                        </span>
                                                    </div>
                                                    <div class="connect-btn not-connect">
