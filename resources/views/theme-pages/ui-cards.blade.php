                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12">
                    ...
                    <div class="row row-cols-12">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="card-img mb-3"
                                        alt="...">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('/assets/img/img-05.jpg') }}" class="card-img mb-3"
                                        alt="...">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" class="card-img mb-3"
                                        alt="...">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="row row-cols-1 row-cols-md-4 g-4">
                        <div class="col">
                            <div class="card">
                                <img src="{{ URL::asset('/assets/img/img-01.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="{{ URL::asset('/assets/img/img-03.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
                                    <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
