        ...
        <div class="content">
            <div class="welcome d-lg-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center welcome-text">
                    <h3 class="d-flex align-items-center"><img src="{{ URL::asset('/assets/img/icons/hi.svg') }}"
            ...
            <div class="row sales-cards">
                <div class="col-xl-6 col-sm-12 col-12">
                    <div class="card d-flex align-items-center justify-content-between default-cover mb-4">
                        ...
                        <img src="{{ URL::asset('/assets/img/icons/weekly-earning.svg') }}" alt="img">
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card color-info bg-primary mb-4">
                        <img src="{{ URL::asset('/assets/img/icons/total-sales.svg') }}" alt="img">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card color-info bg-secondary mb-4">
                        <img src="{{ URL::asset('/assets/img/icons/purchased-earnings.svg') }}" alt="img">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-info">
                                                    <a href="{{ url('product-list') }}" class="product-img">
                                                        <img src="{{ URL::asset('/assets/img/products/stock-img-04.png') }}"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="{{ url('product-list') }}" class="product-img">
                                                        <img src="{{ URL::asset('/assets/img/products/expire-product-01.png') }}"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="{{ url('product-list') }}" class="product-img">
                                                        <img src="{{ URL::asset('/assets/img/products/expire-product-02.png') }}"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="{{ url('product-list') }}" class="product-img">
                                                        <img src="{{ URL::asset('/assets/img/products/expire-product-03.png') }}"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product-info">
                                                    <a href="{{ url('product-list') }}" class="product-img">
                                                        <img src="{{ URL::asset('/assets/img/products/expire-product-04.png') }}"
                                                            alt="product">
                                                    </a>
                                                    <div class="info">
