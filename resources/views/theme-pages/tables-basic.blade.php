                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-list-stacked">
                                                    ...
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ URL::asset('/assets/img/avatar/avatar-11.jpg') }}"
                                                            alt="img">
                                                    </span>
                                                    <span class="avatar avatar-sm avatar-rounded">
                                                        <img src="{{ URL::asset('/assets/img/avatar/avatar-15.jpg') }}"
                                                            alt="img">
                                                    </span>
                                                    <a class="avatar avatar-sm bg-primary text-fixed-white avatar-rounded"
                                                        href="javascript:void(0);">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{ URL::asset('/assets/img/avatar/avatar-12.jpg') }}"
                                                            alt="img">
                                                    </div>
                                                    <div>
                                                        <div class="lh-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs me-2 online avatar-rounded">
                                                        <img src="{{ URL::asset('/assets/img/avatar/avatar-14.jpg') }}"
                                                            alt="img">
                                                    </span>Simon Cowel
                                                </div>
                                            </td>
