                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{ URL::asset('/assets/img/profiles/avatar-03.jpg') }}" alt="image"
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{ URL::asset('/assets/img/profiles/avatar-02.jpg') }}" alt="image"
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="rounded mx-auto d-block" src="{{ URL::asset('/assets/img/img-1.jpg') }}"
                                alt="..." width="200">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="rounded float-end" src="{{ URL::asset('/assets/img/img-1.jpg') }}" alt="..."
                                width="200">
                        </div>
                    </div>
                </div>
