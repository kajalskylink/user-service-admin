        ...
        <div class="content">
            <div class="attendance-header">
                <div class="attendance-content">
                    <img src="{{ URL::asset('/assets/img/icons/hand01.svg') }}" class="hand-img" alt="img">
                        ...
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <div class="card attendance">
                                    <div>
                                        <img src="{{ URL::asset('/assets/img/icons/time-big.svg') }}" alt="time-img">
                                    </div>
                                    <div>
                                        <h2>05:45:22</h2>
                                        <p>Current Time</p>
               ...
               <td>
                <div class="userimgname">
                 <a href="javascript:void(0);" class="product-img">
                  <img src="{{ URL::asset('/assets/img/users/user-06.jpg') }}" alt="product">
                 </a>
                 <div>
