                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-01.svg') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-02.svg') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-03.svg') }}"
                                                        alt="">
                                                </div>
                                                <div class="connect-btn">
                                                    <a href="javascript:void(0);">Connected</a>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-04.svg') }}"
                                                        alt="">
                                                </div>
                                                <div class="connect-btn not-connect">
                                                    <a href="javascript:void(0);">Connect</a>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-05.svg') }}"
                                                        alt="">
                                                </div>
                                                <div class="connect-btn not-connect">
                                                    <a href="javascript:void(0);">Connect</a>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="connected-app-card">
                                        <ul>
                                            <li>
                                                <div class="app-icon">
                                                    <img src="{{ URL::asset('/assets/img/icons/app-icon-06.svg') }}"
                                                        alt="">
                                                </div>
                                                <div class="connect-btn">
                                                    <a href="javascript:void(0);">Connected</a>
