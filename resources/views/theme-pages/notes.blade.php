                                            ...
                                            <div class="notes-card">
                                                ...
                                                <div class="notes-slider-widget">
                                                    <div class="notes-logo">
                                                        <a href="javascript:void(0);">
                                                            <span>
                                                                <img src="{{ URL::asset('/assets/img/profiles/profile-01.png') }}"
                                            ...
                                            <div class="notes-card medium">
                                                ...
                                                <div class="notes-slider-widget">
                                                    <div class="notes-logo">
                                                        <a href="javascript:void(0);">
                                                            <span>
                                                                <img src="{{ URL::asset('/assets/img/profiles/profile-02.png') }}"
                                                                    alt="Profile" class="img-fluid">
                                                            </span>
                                                        </a>
                                                        <div class="d-flex">
                                            ...
                                            <div class="notes-card high">
                                                ...
                                                <div class="notes-slider-widget">
                                                    <div class="notes-logo">
                                                        <a href="javascript:void(0);">
                                                            <span>
                                                                <img src="{{ URL::asset('/assets/img/profiles/profile-03.png') }}"
                                                                    alt="Profile" class="img-fluid">
                                                            </span>
                                                        </a>
                                                        <div class="d-flex">
                                        ...
                                        <div class="notes-card notes-card-details w-100">
                                            ...
                                            <div class="notes-slider-widget notes-widget-profile">
                                                <div class="notes-logo">
                                                    <a href="javascript:void(0);">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/users/user-27.jpg') }}"
                                                                alt="Profile" class="img-fluid">
                                                        </span>
                                                    </a>
                                                    <div class="d-flex">
                                        ...
                                        <div class="notes-card notes-card-details w-100">
                                            ...
                                            <div class="notes-slider-widget notes-widget-profile">
                                                <div class="notes-logo">
                                                    <a href="javascript:void(0);">
                                                        <span>
                                                            <img src="{{ URL::asset('/assets/img/users/user-31.jpg') }}"
                                                                alt="Profile" class="img-fluid">
                                                        </span>
                                                    </a>
                                                    <div class="d-flex">
