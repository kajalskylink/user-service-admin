                                                                    ...
                                                                    <div class="text-editor add-list add">
                                                                        <div class="col-lg-12">
                                                                            <div class="add-choosen">
                                                                                ...
                                                                                <div class="phone-img">
                                                                                    <img src="{{ URL::asset('/assets/img/products/phone-add-2.png')}}"
                                                                                        alt="image">
                                                                                    <a href="javascript:void(0);"><i
                                                                                            data-feather="x"
                                                                                ...
                                                                                <div class="phone-img">
                                                                                    <img src="{{ URL::asset('/assets/img/products/phone-add-1.png')}}"
                                                                                        alt="image">
                                                                                    <a href="javascript:void(0);"><i
                                                                                            data-feather="x"
                                                                                            class="x-square-add remove-product"></i></a>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group image-upload-down">
                                        <div class="image-upload download">
                                            <input type="file">
                                            <div class="image-uploads">
                                                <img src="{{ URL::asset('/assets/img/download-img.png')}}" alt="img">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="add-choosen mb-3">
                                                    <div class="phone-img ms-0">
                                                        <img src="{{ URL::asset('/assets/img/products/phone-add-2.png')}}" alt="image">
                                                        <a href="javascript:void(0);"><i data-feather="x"
                                                                class="x-square-add remove-product"></i></a>
                                                    </div>

                                                    <div class="phone-img">
                                                        <img src="{{ URL::asset('/assets/img/products/phone-add-1.png')}}" alt="image">
                                                        <a href="javascript:void(0);"><i data-feather="x"
                                                                class="x-square-add remove-product"></i></a>
                                                    </div>
                                                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body new-employee-field">
                            <form action="{{ url('brand-list') }}">
                                ...
                                <div class="profile-pic-upload mb-3">
                                    <div class="profile-pic brand-pic">
                                        <span><img src="{{ URL::asset('/assets/img/brand/brand-icon-02.png')}}" alt=""></span>
                                ...
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        ...
                                        <div class="barscaner-img">
                                            <img src="{{ URL::asset('/assets/img/barcode/barcode-01.png')}}" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        ...
                                        <p>Price: $300</p>
                                        <div class="barscaner-img">
                                            <img src="{{ URL::asset('/assets/img/barcode/barcode-02.png')}}" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body custom-modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        <div class="barscaner-img">
                                            <img src="{{ URL::asset('/assets/img/barcode/qr-code.png')}}" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                        <p>Ref No :32RRR554 </p>
                                    </div>
                ...
                <div class="page-wrapper details-blk">
                    <div class="content">
                        <div class="text-center right-sidebar-profile mb-3">
                            <figure class="avatar">
                                <img src="{{ URL::asset('/assets/img/users/user-23.jpg')}}" alt="image">
                            </figure>
                    ...
                    <div class="content">
                        <div class="delete-popup">
                            <div class="delete-image text-center mx-auto">
                                <img src="{{ URL::asset('/assets/img/icons/close-circle.png')}}" alt="Img" class="img-fluid">
                            </div>
...
@if (Route::is(['file-shared']))
    ...
    <div class="toggle-sidebar">
        ...
        <div class="text-center">
            <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/file-manager/folder-lg.png')}}" alt="Folder"></a>
                        ...
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 1" data-bs-original-title="Member 1"><img
                                    src="{{ URL::asset('/assets/img/avatar/avatar-1.jpg')}}" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 2" data-bs-original-title="Member 2"><img
                                    src="{{ URL::asset('/assets/img/avatar/avatar-2.jpg')}}" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 3" data-bs-original-title="Member 3"><img
                                    src="{{ URL::asset('/assets/img/avatar/avatar-3.jpg')}}" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 4" data-bs-original-title="Member 4"><img
                                    src="{{ URL::asset('/assets/img/avatar/avatar-4.jpg')}}" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);"
                ...
                <ul class="mb-4">
                    <li class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-1.jpg')}}"
                        ...
                        <p class="d-flex align-items-center location border-0"><img
                                src="{{ URL::asset('/assets/img/icons/folder.svg')}}" alt="Folder" class="me-2">Website Backup for
                            the Design team</p>
                    </li>
                    <li class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-2.jpg')}}"
                                    alt="Avatar" class="avatar-md"></a>
                    ...
                    <li class="mb-2">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-3.jpg')}}"
                                    alt="Avatar" class="avatar-md"></a>
                            <div>
                    ...
                    <li class="mb-2">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-4.jpg')}}"
                                    alt="Avatar" class="avatar-md"></a>
                            <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="drag-drop text-center mb-4">
                        <div class="upload">
                            <a href="#"><img src="{{ URL::asset('/assets/img/icons/drag-drop.svg')}}" alt=""></a>
                    ...
                    <ul>
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="{{ URL::asset('/assets/img/icons/folder.svg')}}" alt="Folder" class="me-2">
                                <div class="flex-fill">
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="{{ URL::asset('/assets/img/icons/xls.svg')}}" alt="Folder" class="me-2">
                                <div class="flex-fill">
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="{{ URL::asset('/assets/img/icons/zip.svg')}}" alt="Folder" class="me-2">
                                <div class="flex-fill">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="delete-set"><img
                                                                            src="{{ URL::asset('/assets/img/icons/delete.svg')}}"
                                                                            alt="svg')}}"></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <div class="col-lg-12 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                ...
                                                <div class="input-groupicon select-code">
                                                    ...
                                                    <div class="addonset">
                                                        <img src="{{ URL::asset('/assets/img/icons/qrcode-scan.svg')}}" alt="img">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="productimgname">
                                                                <a href="javascript:void(0);"
                                                                    class="product-img stock-img">
                                                                    <img src="{{ URL::asset('/assets/img/products/stock-img-05.png')}}"
                                                                        alt="product">
                                                                </a>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img">
                                                                <img src="{{ URL::asset('/assets/img/products/product6.jpg')}}"
                                                                    alt="product">
                                                            </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img">
                                                                <img src="{{ URL::asset('/assets/img/products/product7.jpg')}}"
                                                                    alt="product">
                                                            </a>
                                                            <a href="javascript:void(0);">Apple Earpods</a>
                                                        </div>
                                                    ...
                                                    <div class="add-icon tab">
                                                        <a class="btn btn-filter" data-bs-toggle="modal"
                                                            data-bs-target="#add-units"><img
                                                                src="{{ URL::asset('/assets/img/icons/plus1.svg')}}" alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="icon-head text-center">
                        <a href="{{ url('pos-design') }}">
                            <img src="{{ URL::asset('/assets/img/logo.png')}}" width="100" height="30" alt="Receipt Logo">
                        </a>
                    </div>
                    ...
                    <div class="text-center invoice-bar">
                        <p>**VAT against this challan is payable through central registration. Thank you for your
                            business!</p>
                        <a href="{{ url('pos-design') }}">
                            <img src="{{ URL::asset('/assets/img/barcode/barcode-03.jpg')}}" alt="Barcode">
                        </a>
                        <p>Sale 31</p>
                    ...
                    <form action="pos">
                        <div class="product-wrap">
                            <div class="product-list d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center flex-fill">
                                    <a href="javascript:void(0);" class="img-bg me-2">
                                        <img src="{{ URL::asset('/assets/img/products/pos-product-16.png')}}" alt="Products">
                                    </a>
                            ...
                            <div class="product-list d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center flex-fill">
                                    <a href="javascript:void(0);" class="img-bg me-2">
                                        <img src="{{ URL::asset('/assets/img/products/pos-product-17.png')}}" alt="Products">
                                    </a>
                                    <div class="info d-flex align-items-center justify-content-between flex-fill">
                                        <div>
                                            <span>PT0235</span>
                                ...
                                <div class="new-employee-field">
                                    <div class="profile-pic-upload">
                                        <div class="profile-pic people-profile-pic">
                                            <img src="{{ URL::asset('/assets/img/profiles/profile.png')}}" alt="Img">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="new-employee-field">
                                            ...
                                            <div class="profile-pic-upload edit-pic">
                                                <div class="profile-pic">
                                                    <span><img src="{{ URL::asset('/assets/img/supplier/edit-supplier.jpg')}}"
                                                            alt=""></span>
                                                    <div class="close-img">
		...
		<div class="tab-content" id="nav-tabContent">
			<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
				...
				<div class="d-flex align-items-center justify-content-between avatar-wrap">
					<div class="avatar-access d-flex align-items-center mb-4">
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 1" data-bs-original-title="Member 1"><img src="{{ URL::asset('/assets/img/avatar/avatar-1.jpg')}}" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 2" data-bs-original-title="Member 2"><img src="{{ URL::asset('/assets/img/avatar/avatar-2.jpg')}}" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 3" data-bs-original-title="Member 3"><img src="{{ URL::asset('/assets/img/avatar/avatar-3.jpg')}}" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
						   <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 4" data-bs-original-title="Member 4"><img src="{{ URL::asset('/assets/img/avatar/avatar-4.jpg')}}" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
			...
			<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
				...
				<ul class="mb-4">
					<li class="mb-4">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-1.jpg')}}" alt="Avatar" class="avatar-md"></a>
							<p>Andrew commented on 1 items <br>3:39 PM Jul 19</p>
						</div>
						<p class="d-flex align-items-center location border-0"><img src="{{ URL::asset('/assets/img/icons/folder.svg')}}" alt="Folder" class="me-2">Website Backup for the Design team</p>
					</li>
					<li class="mb-4">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-2.jpg')}}" alt="Avatar" class="avatar-md"></a>
							<p>Drake shared an item<br>3:39 PM Jul 19</p>
						</div>
						<p class="d-flex align-items-center location border-0"><img src="{{ URL::asset('/assets/img/icons/folder.svg')}}" alt="Folder" class="me-2">Website Backup for the Design team</p>
					</li>
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-3.jpg')}}" alt="Avatar" class="avatar-md"></a>
							<div><p class="mb-0 text-secondary">Melvin</p><p class="mb-0">Commentor</p></div>
						</div>
					</li>
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="{{ URL::asset('/assets/img/avatar/avatar-4.jpg')}}" alt="Avatar" class="avatar-md"></a>
																...
																<td>
																	<div class="productimgname">
																		<a href="javascript:void(0);" class="product-img stock-img">
																			<img src="{{ URL::asset('/assets/img/products/stock-img-02.png')}}" alt="product">
																		</a>
																		<a href="javascript:void(0);">Nike Jordan</a>
																	</div>
																</td>
												...
												<table class="table">
													...
													<tbody>
														<tr>
															...
															<td>
																<a class="delete-set"><img
																		src="{{ URL::asset('/assets/img/icons/delete.svg')}}" alt="svg')}}"></a>
															</td>
														</tr>
													</tbody>
												</table>
												...
												<table class="table  datanew">
													...
													<tbody>
														<tr>
															<td>
																<a class="product-img">
																	<img src="{{ URL::asset('/assets/img/products/product1.jpg')}}" alt="product">
																</a>
															</td>
															<td>2/27/2022</td>
														...
														<tr>
															<td>
																<a class="product-img">
																	<img src="{{ URL::asset('/assets/img/products/product5.jpg')}}" alt="product">
																</a>
															</td>
															<td>3/24/2022</td>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="new-employee-field">
												...
												<div class="profile-pic-upload edit-pic">
													<div class="profile-pic">
														<span><img src="{{ URL::asset('/assets/img/users/edit-user.jpg')}}" class="user-editer" alt="User"></span>
														<div class="close-img">
															<i data-feather="x" class="info-img"></i>
														</div>
													</div>
